...
fname('h_diff_graph_complete.txt').
...
trans(State,StateNext):-State=[Stat6,Il_4r,Il_4,Socs1,Gata3,Inf_y,Inf_yr,Stat1,T_bet],
						(stat6(Stat6N,[Il_4r]);Stat6N=Stat6),
						(il_4r(Il_4rN,[Il_4,Socs1]);Il_4rN=Il_4r),
						(il_4(Il_4N,[Stat1,Gata3]);Il_4N=Il_4),
						(socs1(Socs1N,[Stat1,T_bet]);Socs1N=Socs1),
						(gata3(Gata3N,[Gata3,Stat6,T_bet]);Gata3N=Gata3),
						(inf_y(Inf_yN,[T_bet]);Inf_yN=Inf_y),
						(inf_yr(Inf_yrN,[Inf_y,Socs1]);Inf_yrN=Inf_yr),
						(stat1(Stat1N,[Inf_yr]);Stat1N=Stat1),
						(t_bet(T_betN,[T_bet,Stat1,Gata3]);T_betN=T_bet),				
